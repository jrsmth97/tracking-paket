                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        {!! Form::text('telepon_seluler', null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        {!! Form::text('nama_agen', null, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        @endif
                                        @if(!empty($agen))
                                        {!! Form::select('type', $wilayah , null, ['class' => 'form-control', 'readonly' => $disableInput]) !!}
                                        @else
                                        <select id="inputState" name="wilayah" class="form-control">
                                            <option holder>Pilih Kota/Kabupaten</option>
                                            <option value="">...</option>
                                        </select>
                                        @endif
                                    </div>
